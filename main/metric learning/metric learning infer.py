...
df = pd.read_csv(r'../txt/img_test_path_new.csv')
image_paths = r'D:\xiangsitu\img_test_new/' + df['imgPath']
image_embeddings = get_image_embeddings(image_paths.values)

# 修改
np.save(f'../data/metric_learning_250_new_5_newTest.npy', image_embeddings)
