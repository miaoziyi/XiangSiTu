...
df = pd.read_csv(r'D:\mzy\imgs_1w\result_1.csv')
image_paths = r'D:\mzy\imgs_1w\imgs_1/' + df['imgPath']
image_embeddings = get_image_embeddings(image_paths.values)

# 修改
np.save(f'../data/metric 17/metric_learning_17_{epoch}_{loss_module}_bigS.npy', image_embeddings)
